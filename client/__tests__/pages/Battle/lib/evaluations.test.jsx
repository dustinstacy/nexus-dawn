...
const RULES_STD = () => (Object.assign({}, BASE_RULES, {
    "standard": true
}))
const RULES_LOW = () => (Object.assign({}, BASE_RULES, {
    "low": true
}))
const RULES_STD_LOW = () => (Object.assign({}, BASE_RULES, {
    "standard": true,
    "low": true
}))
    ...
    describe('evaluateSameAndPlus', () => {
        describe('with "same" rules', () => {
            describe.each([{
                ...
                test.each([
                    [
                        [RED_CARD(), RED_CARD()], rules, [0, 0],
                        [0, 0],
                        [TRUE, TRUE]
                    ],
                    [
                        [RED_CARD(), RED_CARD()], rules, [1, 2],
                        [1, 2],
                        [TRUE, TRUE]
                    ],
                    [
                        [RED_CARD(), RED_CARD()], rules, [123, 45],
                        [123, 45],
                        [TRUE, TRUE]
                    ],
                ...
                test.each([
                    [
                        [RED_CARD(), BLUE_CARD()], rules, [0, 0],
                        [0, 0],
                        [TRUE, NULL]
                    ],
                    [
                        [BLUE_CARD(), RED_CARD()], rules, [0, 0],
                        [0, 0],
                        [NULL, TRUE]
                    ],
                ...
                test.each([
                    [
                        [RED_CARD(), RED_CARD()], rules, [0, 1],
                        [2, 3],
                        [NULL, NULL]
                    ],
                    [
                        [RED_CARD(), RED_CARD()], rules, [123, 456],
                        [123, 789],
                        [NULL, NULL]
                    ],
                    [
        ...
        describe('with "plus" rules', () => {
            describe.each([{
                ...
                test.each([
                    ...
                    [
                        [RED_CARD(), RED_CARD()], rules, [9, 5],
                        [0, 4],
                        [TRUE, TRUE]
                    ],
                    [
                        [RED_CARD(), RED_CARD()], rules, [999, 499],
                        [1, 501],
                        [TRUE, TRUE]
                    ],
                ...
                test.each([
                    [
                        [RED_CARD(), BLUE_CARD()], rules, [1, 2],
                        [3, 2],
                        [TRUE, NULL]
                    ],
                    [
                        [BLUE_CARD(), RED_CARD()], rules, [7, 8],
                        [5, 4],
                        [NULL, TRUE]
                    ],
        ...
        describe('with "same" and "plus" rules', () => {
            describe.each([{
                ...
                test.each([
                    ...
                    [
                        [RED_CARD(), RED_CARD()], rules, [3, 3],
                        [3, 3],
                        [TRUE, TRUE]
                    ],
                    [
                        [RED_CARD(), RED_CARD()], rules, [999, 999],
                        [999, 999],
                        [TRUE, TRUE]
                    ],
                    ...
                    [
                        [RED_CARD(), RED_CARD()], rules, [999, 555],
                        [999, 555],
                        [TRUE, TRUE]
                    ],
                ...
                test.each([
                    ...
                    [
                        [RED_CARD(), BLUE_CARD()], rules, [3, 3],
                        [3, 3],
                        [TRUE, NULL]
                    ],
                    [
                        [BLUE_CARD(), RED_CARD()], rules, [999, 999],
                        [999, 999],
                        [NULL, TRUE]
                    ],
                    ...
                    [
                        [BLUE_CARD(), RED_CARD()], rules, [9, 5],
                        [9, 5],
                        [NULL, TRUE]
                    ],
                    [
                        [RED_CARD(), BLUE_CARD()], rules, [999, 555],
                        [999, 555],
                        [TRUE, NULL]
                    ],
                    ...
                    // Plus
                    [
                        [BLUE_CARD(), RED_CARD()], rules, [2, 1],
                        [1, 2],
                        [NULL, TRUE]
                    ],
                    [
                        [RED_CARD(), BLUE_CARD()], rules, [9, 5],
                        [0, 4],
                        [TRUE, NULL]
                    ],
                    [
                        [BLUE_CARD(), RED_CARD()], rules, [999, 499],
                        [1, 501],
                        [NULL, TRUE]
                    ],
                ...
                test.each([
                    ...
                    [
                        [BLUE_CARD(), BLUE_CARD()], rules, [3, 3],
                        [3, 3],
                        [NULL, NULL]
                    ],
                    [
                        [BLUE_CARD(), BLUE_CARD()], rules, [999, 999],
                        [999, 999],
                        [NULL, NULL]
                    ],
                    ...
                    // Same
                    [
                        [BLUE_CARD(), BLUE_CARD()], rules, [1, 2],
                        [1, 2],
                        [NULL, NULL]
                    ],
                    [
                        [BLUE_CARD(), BLUE_CARD()], rules, [9, 5],
                        [9, 5],
                        [NULL, NULL]
                    ],
                    [
                        [BLUE_CARD(), BLUE_CARD()], rules, [999, 555],
                        [999, 555],
                        [NULL, NULL]
                    ],
                    ...
                    [
                        [BLUE_CARD(), BLUE_CARD()], rules, [999, 499],
                        [1, 501],
                        [NULL, NULL]
                    ],
