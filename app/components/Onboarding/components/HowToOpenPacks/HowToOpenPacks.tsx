                    ...
                    <div className='open-pack stage around-column'>
                        ...
                        {step === 1 && (
                            <div className='body box start-column'>
                                ...
                                <Button label={onboardingStages[2].label[0]} onClick={incrementStep} />
                            </div>
                        )}
                        {step === 2 && (
                            <div className='body box center'>
                                <p>{onboardingStages[2].body[1]}</p>
                                <img src={packOdds.src} alt='pack odds' />
                                <Button label={onboardingStages[2].label[0]} onClick={incrementStep} />
                            </div>
                        )}
                        {step === 3 && (
                            <div className='body box center'>
                                ...
                                <img src={openPack.src} alt='pack odds' />
                                <Button label={onboardingStages[2].label[1]} onClick={() => toggleModalOpen()} />
                            </div>
                        )}
                        {step === 4 && (
                            <div className='body box center'>
                                <p>{onboardingStages[2].body[3]}</p>
                                <img src={cardValues.src} alt='cardValues' />
                                <Button label={onboardingStages[2].label[0]} onClick={handleClick} />
                            </div>
                        )}
                    </div>
                </ModalOverlay>
