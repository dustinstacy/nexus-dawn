                    ...
                    <div className='get-cards stage around-column'>
                        ...
                        {step === 1 && (
                            <div className='body box start-column'>
                                ...
                                <Button label={onboardingStages[1].label[0]} onClick={incrementStep} />
                            </div>
                        )}
                        {step === 2 && (
                            <div className='body box step-2 center'>
                                <p>{onboardingStages[1].body[1]}</p>
                                <img className='market-menu-image' src={marketMenu.src} alt='market menu' />
                                <Button label={onboardingStages[1].label[0]} onClick={incrementStep} />
                            </div>
                        )}
                        {step === 3 && (
                            <div className='body box center-column'>
                                ...
                                <img className='purchase-bar-image' src={purchaseButton.src} alt='market menu' />
                                <Button label={onboardingStages[1].label[1]} onClick={() => toggleModalOpen()} />
                            </div>
                        )}
                        {step === 4 && (
                            <div className='body box center-column'>
                                <p>{onboardingStages[1].body[3]}</p>
                                <Button label={onboardingStages[1].label[0]} onClick={() => nextStage("/packs")} />
                            </div>
                        )}
                    </div>
                </ModalOverlay>
