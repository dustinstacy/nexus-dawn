                    ...
                    <div className='build-deck stage around-column'>
                        ...
                        {step === 1 && (
                            <div className='body box start-column'>
                                ...
                                <Button label={onboardingStages[3].label[0]} onClick={incrementStep} />
                            </div>
                        )}
                        {step === 2 && (
                            <div className='body box step-2 center-column'>
                                <p>{onboardingStages[3].body[1]}</p>
                                <img className='optimize-deck-image' src={optimizeDeck.src} alt='market menu' />
                                <Button label={onboardingStages[3].label[0]} onClick={incrementStep} />
                            </div>
                        )}
                        {step === 3 && (
                            <div className='body box step-3 center'>
                                ...
                                <img className='check-box-image' src={checkbox.src} alt='market menu' />
                                <Button label={onboardingStages[3].label[1]} onClick={() => toggleModalOpen()} />
                            </div>
                        )}
                        {step === 4 && (
