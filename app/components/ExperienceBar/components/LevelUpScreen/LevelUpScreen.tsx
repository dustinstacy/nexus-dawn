...
const LevelUpScreen = ({ setNewLevelAlert }: LevelUpScreenProps) => {
    ...
    return (
        <div className='level-up fill start-column'>
            <h1>Level Up</h1>
            {animationFinished && (
                <AiOutlineCloseCircle className='close-modal' onClick={() => setNewLevelAlert(false)} />
            )}
                ...
                {level < 10 && (
                    <>
                        <div className='unlock start-column panel background-gradient'>
                            ...
                            <img src={sortedItems[level - 1]?.image} alt='market item' />
                        ...
                        <div className='unlock start-column panel background-gradient'>
                            ...
                            <img src={allOpponents[level - 1]?.image} alt='unlocked opponent' />
