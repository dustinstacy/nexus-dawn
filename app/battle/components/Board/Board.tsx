...
const Board = ({
    ...
    const p1ImageClassNames = classSet("user-image", "p1-image", isP1Turn && isP1Turn !== null && "is-turn")
    const p2ImageClassNames = classSet("user-image", "p2-image", !isP1Turn && isP1Turn !== null ? "is-turn" : "")
    ...
    return (
        <div className='board center'>
                    ...
                    contents === "empty" ? (
                        ...
                        <div key={i}>
                            <Cell
                                ...
                                cardSelected={false}
                            >
                                <Card card={contents} handleClick={undefined} isShowing />
                            </Cell>
                        </div>
                    )
                )}
            ...
            <div className='arrow-column center-column'>
                ...
                <img className={p2ImageClassNames} src={playerTwo.user?.avatar} alt='p2 image' />
                <img className={turnArrowClassNames} src={turnArrow.src} alt='turn arrow' />
                <img className={p1ImageClassNames} src={playerOne.user?.image} alt='p1 image' />
