        ...
        <>
            {selectedCard ? (
                <div className='selected-card center fill'>
                    <AiOutlineCloseCircle className='unselect-card' onClick={() => setSelectedCard?.(null)} />
                ...
                <div className='select-card fill center' onClick={() => setCardSelectOpen(true)}>
                    <h1>+</h1>
                </div>
            )}
            ...
            {cardSelectOpen && (
                <ModalOverlay>
                    <CardListContainer setSelectedCard={setSelectedCard} setCardSelectOpen={setCardSelectOpen} />
                </ModalOverlay>
            )}
        </>
    )
